...
You can also try the Sketch to Action app that uses MCP servers to implement the design in Figma to code in GitHub repo. Follow the instruction in the [Sketch to Action README](../sample/sketch-to-action) to test it out!